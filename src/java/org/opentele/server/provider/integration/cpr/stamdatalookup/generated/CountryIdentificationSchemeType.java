...
public enum CountryIdentificationSchemeType {
    ...
    /**
     * Dette format foelge ISO 3166 standarden, alpha 2.
     * 
     */
    ...
    /**
     * Dette format foelge ISO 3166 standarden, alpha 3.
     * 
     */
    ...
    /**
     * Dette format foelger FNs Statistik Kontor landekoder
     * 
     */
    ...
    /**
     * Dette format foelger MyndighedsKoden fra Det Centrale Personregister
     *                     
     * 
     */
    @XmlEnumValue("imk")
