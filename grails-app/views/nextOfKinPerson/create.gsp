...
<g:set var="entityName"
	value="${message(code: 'nextOfKinPerson.create.label', default: 'NextOfKinPerson')}" />
<title><g:message code="default.create.label"
		args="[entityName]" /></title>
</head>

<body>
	<div id="create-nextOfKinPerson" class="content scaffold-create" role="main">
		...
		<g:form action="save">
			...
			<fieldset class="buttons">
				<g:hiddenField name="patientID" value="${patientInstanceId}" />
